    ...
    <div class="col-span-1 bg-white p-4 h-max sticky top-4">
      ...
      @foreach($categories as $category)
          <div class="ml-4 mb-2">
            ...
            <lavel for="category{{$category['id']}}">{{$category['name']}}</lavel>
          </div>
      @endforeach
        </div>
